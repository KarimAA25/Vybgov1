...
import '../../cab_detail/views/widget/price_row_view.dart';
                                            ...
                                            children: [
                                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                ...
                                                Row(children: [
                                                  ...
                                                  GestureDetector(
                                                      onTap: () => Get.offAllNamed(Routes.RENTAL_RIDE_SCREEN),
                                                      child: TextCustom(title: 'Rental Ride'.tr, fontSize: 14, fontFamily: AppThemeData.medium, color: AppThemData.greyShade500)),
                                                  const TextCustom(title: ' / ', fontSize: 14, fontFamily: AppThemeData.medium, color: AppThemData.greyShade500),
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          Column(
                                                            ...
                                                            children: [
                                                              TextCustom(
                                                                  title: "Order ID # ${controller.rentalModel.value.id!.substring(0, 8)}",
                                                                  fontSize: 18,
                                                                  fontFamily: AppThemeData.bold),
                                                              spaceH(height: 2),
                                                              TextCustom(
                                                                  title:
                                                                      "${Constant.timestampToDate(controller.rentalModel.value.createAt!)} at ${Constant.timestampToTime(controller.rentalModel.value.createAt!)}",
                                                                  fontSize: 14,
                                                          ...
                                                          spaceW(),
                                                          Container(
                                                            child: Constant.bookingStatusText(context, controller.rentalModel.value.bookingStatus.toString()),
                                                          ),
                                                        ],
                                                      ),
                                                      spaceH(height: 40),
                                                      ...
                                                      controller.rentalModel.value.cancelledReason != null && controller.rentalModel.value.cancelledReason.toString().isNotEmpty
                                                          ? Column(
                                                              crossAxisAlignment: CrossAxisAlignment.start,
                                                              children: [
                                                                spaceH(height: 20),
                                                                ...
                                                                spaceH(height: 8),
                                                                TextCustom(title: controller.rentalModel.value.cancelledReason.toString())
                                                              ],
                                                            )
                                                          : const SizedBox(),
                                                      spaceH(height: 20),
                                                      ...
                                                      Row(
                                                        children: [
                                                          (controller.rentalModel.value.paymentType == controller.paymentModel.value.cash!.name)
                                                              ? SvgPicture.asset("assets/icons/ic_cash.svg")
                                                              : (controller.rentalModel.value.paymentType == controller.paymentModel.value.wallet!.name)
                                                                  ? SvgPicture.asset(
                                                                      "assets/icons/ic_wallet.svg",
                                                                      height: 24,
                                                                      color: themeChange.isDarkTheme() ? AppThemData.lightGrey08 : AppThemData.black08,
                                                                    )
                                                                  : (controller.rentalModel.value.paymentType == controller.paymentModel.value.razorpay!.name)
                                                                      ? Image.asset("assets/image/ig_razorpay.png", height: 24, width: 24)
                                                                      : (controller.rentalModel.value.paymentType == controller.paymentModel.value.paypal!.name)
                                                                          ? Image.asset("assets/image/ig_paypal.png", height: 24, width: 24)
                                                                          : (controller.rentalModel.value.paymentType == controller.paymentModel.value.strip!.name)
                                                                              ? Image.asset("assets/image/ig_stripe.png", height: 24, width: 24)
                                                                              : (controller.rentalModel.value.paymentType == controller.paymentModel.value.payStack!.name)
                                                                                  ? Image.asset("assets/image/ig_paystack.png", height: 24, width: 24)
                                                                                  : (controller.rentalModel.value.paymentType == controller.paymentModel.value.mercadoPago!.name)
                                                                                      ? Image.asset("assets/image/ig_marcadopago.png", height: 24, width: 24)
                                                                                      : (controller.rentalModel.value.paymentType == controller.paymentModel.value.payFast!.name)
                                                                                          ? Image.asset("assets/image/ig_payfast.png", height: 24, width: 24)
                                                                                          : (controller.rentalModel.value.paymentType ==
                                                                                                  controller.paymentModel.value.flutterWave!.name)
                                                                                              ? Image.asset("assets/image/ig_flutterwave.png", height: 24, width: 24)
                                                                                              : (controller.rentalModel.value.paymentType ==
                                                                                                      controller.paymentModel.value.xendit!.name)
                                                                                                  ? Image.asset("assets/image/ig_xendit.png", height: 24, width: 24)
                                                                                                  : (controller.rentalModel.value.paymentType ==
                                                                                                          controller.paymentModel.value.midtrans!.name)
                                                                                                      ? Image.asset("assets/image/ig_midtrans.png", height: 24, width: 24)
                                                                                                      : SvgPicture.asset("assets/icons/ic_cash.svg"),
                                                          spaceW(width: 8),
                                                          TextCustom(
                                                            title: "${controller.rentalModel.value.paymentType}",
                                                            fontSize: 14,
                                                          ...
                                                          Row(
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                  child: rowDataWidget(
                                                                      name: "Date",
                                                                      value: controller.rentalModel.value.bookingTime == null
                                                                          ? ""
                                                                          : controller.rentalModel.value.bookingTime!.toDate().dateMonthYear(),
                                                                      themeChange: themeChange)),
                                                            ],
                                                          ),
                                                          Row(children: [
                                                            ...
                                                            Expanded(
                                                                child: rowDataWidget(
                                                                    ...
                                                                    value: controller.rentalModel.value.bookingTime == null
                                                                        ? ""
                                                                        : controller.rentalModel.value.bookingTime!.toDate().time(),
                                                                    themeChange: themeChange)),
                                                          ]),
                                                        ],
                                                      ),
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          TextCustom(
                                                            title: "Rental Package".tr,
                                                            fontSize: 16,
                                                            fontFamily: AppThemeData.bold,
                                                          ),
                                                          spaceH(height: 16),
                                                          rowDataWidget(
                                                              name: "Package", value: controller.rentalModel.value.rentalPackage!.title.toString(), themeChange: themeChange),
                                                          rowDataWidget(
                                                              name: "Base Fare",
                                                              value: Constant.amountShow(amount: controller.rentalModel.value.rentalPackage!.baseFare.toString()),
                                                              themeChange: themeChange),
                                                          rowDataWidget(
                                                              name: "Included KM & Hours",
                                                              value:
                                                                  "${controller.rentalModel.value.rentalPackage!.includedDistance} km / ${controller.rentalModel.value.rentalPackage!.includedHours} Hours",
                                                              themeChange: themeChange),
                                                          rowDataWidget(
                                                              name: "Extra Per KM Charge",
                                                              value: controller.rentalModel.value.rentalPackage!.extraKmFare != null
                                                                  ? Constant.amountShow(amount: controller.rentalModel.value.rentalPackage!.extraKmFare.toString())
                                                                  : Constant.amountShow(amount: "0.0"),
                                                              themeChange: themeChange),
                                                          rowDataWidget(
                                                              name: "Extra Per Hour Charge",
                                                              value: controller.rentalModel.value.rentalPackage!.extraHourFare != null
                                                                  ? Constant.amountShow(amount: controller.rentalModel.value.rentalPackage!.extraHourFare.toString())
                                                                  : Constant.amountShow(amount: "0.0"),
                                                              themeChange: themeChange)
                                                        ],
                                                      ),
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          TextCustom(
                                                            title: "Extra KM & Hours".tr,
                                                            fontSize: 16,
                                                            fontFamily: AppThemeData.bold,
                                                          ),
                                                          spaceH(height: 16),
                                                          rowDataWidget(name: "Extra KM", value: "${controller.extraKm.value} KM", themeChange: themeChange),
                                                          rowDataWidget(name: "Extra Hours", value: "${controller.extraHours.value} Hour", themeChange: themeChange),
                                                        ],
                                                      ),
                                                      spaceH(height: 20),
                                                      Column(
                                                                ...
                                                                Expanded(
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextCustom(
                                                                        title: controller.rentalModel.value.pickUpLocationAddress.toString(),
                                                                        maxLine: 3,
                                                                        fontSize: 16,
                                                                      )
                                                                    ],
                                              ...
                                              Container(
                                                ...
                                                child: Obx(() => Column(
                                                      ...
                                                      children: [
                                                                ...
                                                                Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                  SizedBox(
                                                                    ...
                                                                    child: CachedNetworkImage(
                                                                        imageUrl: controller.rentalModel.value.vehicleType == null
                                                                            ? Constant.userPlaceHolder
                                                                            : controller.rentalModel.value.vehicleType!.image.toString(),
                                                                        fit: BoxFit.cover,
                                                                  ...
                                                                  Expanded(
                                                                      child: TextCustom(
                                                                          title: (controller.rentalModel.value.vehicleType == null
                                                                              ? ""
                                                                              : controller.rentalModel.value.vehicleType!.title.toString()),
                                                                          fontSize: 16,
                                                                          fontFamily: AppThemeData.medium)),
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      TextCustom(
                                                                          title: (controller.rentalModel.value.vehicleType == null
                                                                              ? ""
                                                                              : controller.rentalModel.value.vehicleType!.persons.toString()),
                                                                          fontSize: 16,
                                                                          fontFamily: AppThemeData.regular)
                                                                    ],
                                                                  )
                                                        ...
                                                        spaceH(height: 24),
                                                        PriceRowView(
                                                          price: Constant.amountShow(amount: controller.rentalModel.value.subTotal.toString()),
                                                          title: "Amount".tr,
                                                        ...
                                                        PriceRowView(
                                                          price: Constant.amountShow(amount: controller.rentalModel.value.extraKmCharge.toString()),
                                                        ...
                                                        const SizedBox(height: 16),
                                                        PriceRowView(
                                                          price: Constant.amountShow(amount: controller.rentalModel.value.extraHourCharge.toString()),
                                                        ...
                                                        const SizedBox(height: 16),
                                                        PriceRowView(
                                                            price: Constant.amountToShow(amount: controller.rentalModel.value.discount ?? '0.0'),
                                                            title: (controller.rentalModel.value.coupon?.code ?? '').isEmpty
                                                                ? "Discount".tr
                                                        ...
                                                        PriceRowView(
                                                          price: Constant.amountShow(amount: Constant.calculateFinalRentalRideAmount(controller.rentalModel.value).toString()),
                                                                                                    ...
                                                                                                    : (controller.rentalModel.value.paymentType ==
                                                                                                        ...
                                                                                                        : (controller.rentalModel.value.paymentType ==
                                                                                                            ...
                                                                                                            : (controller.rentalModel.value.paymentType ==
                                                                                                                ...
                                                                                                                : (controller.rentalModel.value.paymentType ==
                                                                                                                        controller.paymentModel.value.midtrans!.name)
                                                                                                                    ? Image.asset("assets/image/ig_midtrans.png",
                                                                                                                        height: 24, width: 24)
                                                                                                                    : SvgPicture.asset("assets/icons/ic_cash.svg"),
                                                                        spaceW(width: 8),
                                                                        TextCustom(
                                                              ...
                                                              SizedBox(
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    rowDataWidget(
                                                                        name: "Package",
                                                                        value: controller.rentalModel.value.rentalPackage!.title.toString(),
                                                                        themeChange: themeChange),
                                                                    rowDataWidget(
                                                                        name: "Base Fare",
                                                                        value: Constant.amountShow(amount: controller.rentalModel.value.rentalPackage!.baseFare.toString()),
                                                          ...
                                                          children: [
                                                            Container(
                                                                ...
                                                                decoration: ShapeDecoration(
                                                                  ...
                                                                  shape: RoundedRectangleBorder(
                                                                    side: BorderSide(
                                                                        width: 1, color: themeChange.isDarkTheme() ? AppThemData.greyShade800 : AppThemData.greyShade100),
                                                                    borderRadius: BorderRadius.circular(12),
                                                                  ),
                                                                ),
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          SvgPicture.asset("assets/icons/ic_multi_person.svg", color: AppThemData.primary500),
                                                                          spaceW(width: 6),
                                                                          TextCustom(
                                                                              title: (controller.rentalModel.value.vehicleType == null
                                                                                  ? ""
