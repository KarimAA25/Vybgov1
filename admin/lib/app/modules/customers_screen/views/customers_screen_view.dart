                                        ...
                                        : DataTable(
                                            ...
                                            columns: [
                                              ...
                                              CommonUI.dataColumnWidget(context,
                                                  columnTitle: "Full Name".tr, width: ResponsiveWidget.isMobile(context) ? 150 : MediaQuery.of(context).size.width * 0.12),
                                              CommonUI.dataColumnWidget(context,
                                              ...
                                              CommonUI.dataColumnWidget(context, columnTitle: "Loyalty Points".tr, width: 140),
                                              CommonUI.dataColumnWidget(context,
                                            ...
                                            rows: controller.currentPageUser
                                                .map((userModel) => DataRow(cells: [
                                                      ...
                                                      DataCell(TextCustom(title: Constant.maskEmail(email: userModel.email.toString()))),
                                                      ...
                                                      DataCell(TextCustom(title: "${userModel.loyaltyCredits ?? "0"} pts")),
                                                      DataCell(
                                                        Transform.scale(
                                                          scale: 0.8,
                ...
                children: [
                  Align(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                          decoration: const BoxDecoration(shape: BoxShape.circle), padding: const EdgeInsets.all(10), child: const Icon(Icons.arrow_back_ios_new_outlined)),
                    ),
                  ),
                  Padding(
                                    ...
                                    Align(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                            ...
                                            width: 30,
                                            decoration:
                                                BoxDecoration(shape: BoxShape.circle, color: themeChange.isDarkTheme() ? AppThemData.greyShade900 : AppThemData.greyShade100),
                                            child: const Icon(
                                              Icons.edit,
                                              size: 20,
                                            )),
                            ...
                            CustomButtonWidget(
                                ...
                                onPress: () async {
                                  if (Constant.isDemo) {
                                    ...
                                    controller.userModel.value.searchNameKeywords = Constant.generateKeywords(controller.userNameController.value.text);
