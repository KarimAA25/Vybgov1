                                                      ...
                                                      .map((subscriptionHistory) => DataRow(cells: [
                                                            ...
                                                            DataCell(
                                                              FutureBuilder<DriverUserModel?>(
                                                                  future: FireStoreUtils.getDriverByDriverID(subscriptionHistory.driverId.toString()), // async work
                                                            ...
                                                            DataCell(
                                                              Container(
                                                                  ...
                                                                  child: TextCustom(
                                                                    title:
                                                                        (subscriptionHistory.expiryDate == null || subscriptionHistory.expiryDate!.toDate().isAfter(DateTime.now()))
                                                                            ? "Active"
                                                                            : "Expired",
                                                                    color:
                                                                        (subscriptionHistory.expiryDate == null || subscriptionHistory.expiryDate!.toDate().isAfter(DateTime.now()))
