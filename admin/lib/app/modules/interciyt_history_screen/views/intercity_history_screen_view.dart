                                          ...
                                          : DataTable(
                                              ...
                                              rows: controller.currentPageBooking
                                                  .map((intercityModel) => DataRow(cells: [
                                                        DataCell(
                                                          TextCustom(
                                                            title: intercityModel.id!.isEmpty ? "N/A".tr : "#${intercityModel.id!.substring(0, 8)}",
                                                          ),
                                                        ),
                                                        DataCell(
                                                          FutureBuilder<UserModel?>(
                                                              future: FireStoreUtils.getUserByUserID(intercityModel.customerId.toString()), // async work
                                                        ...
                                                        DataCell(TextCustom(title: intercityModel.createAt == null ? '' : Constant.timestampToDateTime(intercityModel.createAt!))),
                                                        DataCell(TextCustom(title: bool.parse(intercityModel.paymentStatus!.toString()) ? "Paid".tr : "Unpaid".tr)),
                                                        DataCell(
                                                        ...
                                                        DataCell(TextCustom(title: Constant.amountShow(amount: Constant.calculateInterCityFinalAmount(intercityModel).toString()))),
                                                        DataCell(
                                                          Container(
