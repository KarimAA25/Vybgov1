...
class CabBookingScreenView extends GetView<CabBookingController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<CabBookingController>(
                                                ...
                                                child: DropdownSearch<DriverUserModel>(
                                                  ...
                                                  popupProps: PopupProps.menu(
                                                      ...
                                                      searchFieldProps: TextFieldProps(
                                                          cursorColor: themeChange.isDarkTheme() ? AppThemData.greyShade500 : AppThemData.greyShade800,
                                                          style: TextStyle(
                                                            fontFamily: AppThemeData.regular,
                                                            fontSize: 16,
                                          ...
                                          : DataTable(
                                              ...
                                              rows: controller.currentPageBooking
                                                  .map((bookingModel) => DataRow(cells: [
                                                        ...
                                                        DataCell(TextCustom(title: Constant.amountShow(amount: Constant.calculateFinalAmount(bookingModel).toString()))),
                                                        DataCell(
                                                          Container(
