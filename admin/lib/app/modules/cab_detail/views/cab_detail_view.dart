                                          ...
                                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                            ...
                                            Row(children: [
                                              ...
                                              GestureDetector(
                                                  ...
                                                  child: TextCustom(title: 'Cab Booking'.tr, fontSize: 14, fontFamily: AppThemeData.medium, color: AppThemData.greyShade500)),
                                              const TextCustom(title: ' / ', fontSize: 14, fontFamily: AppThemeData.medium, color: AppThemData.greyShade500),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  children: [
                                                    TextCustom(
                                                        title: "Order ID # ${controller.bookingModel.value.id!.substring(0, 8)}", fontSize: 18, fontFamily: AppThemeData.bold),
                                                    spaceH(height: 2),
                                                    TextCustom(
                                                        title:
                                                ...
                                                controller.bookingModel.value.cancelledReason != null && controller.bookingModel.value.cancelledReason.toString().isNotEmpty
                                                    ? Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          spaceH(height: 20),
                                                ...
                                                Row(
                                                  children: [
                                                    (controller.bookingModel.value.paymentType == controller.paymentModel.value.cash!.name)
                                                        ? SvgPicture.asset("assets/icons/ic_cash.svg")
                                                        : (controller.bookingModel.value.paymentType == controller.paymentModel.value.wallet!.name)
                                                            ? SvgPicture.asset(
                                                                "assets/icons/ic_wallet.svg",
                                                                height: 24,
                                                                color: themeChange.isDarkTheme() ? AppThemData.lightGrey08 : AppThemData.black08,
                                                              )
                                                            : (controller.bookingModel.value.paymentType == controller.paymentModel.value.razorpay!.name)
                                                                ? Image.asset("assets/image/ig_razorpay.png", height: 24, width: 24)
                                                                : (controller.bookingModel.value.paymentType == controller.paymentModel.value.paypal!.name)
                                                                    ? Image.asset("assets/image/ig_paypal.png", height: 24, width: 24)
                                                                    : (controller.bookingModel.value.paymentType == controller.paymentModel.value.strip!.name)
                                                                        ? Image.asset("assets/image/ig_stripe.png", height: 24, width: 24)
                                                                        : (controller.bookingModel.value.paymentType == controller.paymentModel.value.payStack!.name)
                                                                            ? Image.asset("assets/image/ig_paystack.png", height: 24, width: 24)
                                                                            : (controller.bookingModel.value.paymentType == controller.paymentModel.value.mercadoPago!.name)
                                                                                ? Image.asset("assets/image/ig_marcadopago.png", height: 24, width: 24)
                                                                                : (controller.bookingModel.value.paymentType == controller.paymentModel.value.payFast!.name)
                                                                                    ? Image.asset("assets/image/ig_payfast.png", height: 24, width: 24)
                                                                                    : (controller.bookingModel.value.paymentType == controller.paymentModel.value.flutterWave!.name)
                                                                                        ? Image.asset("assets/image/ig_flutterwave.png", height: 24, width: 24)
                                                                                        : (controller.bookingModel.value.paymentType == controller.paymentModel.value.xendit!.name)
                                                    ...
                                                    Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                      SizedBox(
                                                        ...
                                                        child: CachedNetworkImage(
                                                            imageUrl: controller.bookingModel.value.vehicleType!.image!.isEmpty
                                                      ...
                                                      Expanded(
                                                          child: TextCustom(
                                                              title: (controller.bookingModel.value.vehicleType!.title!.isEmpty
                                                                  ? ""
                                                                  : controller.bookingModel.value.vehicleType!.title.toString()),
                                                              fontSize: 16,
                                                              fontFamily: AppThemeData.medium)),
                                                      Row(
                                                        children: [
                                                          ...
                                                          spaceW(width: 6),
                                                          TextCustom(
                                                              title: (controller.bookingModel.value.vehicleType!.persons!.isEmpty
                                                                  ? ""
                                                                  : controller.bookingModel.value.vehicleType!.persons.toString()),
                                                              fontSize: 16,
                                                              fontFamily: AppThemeData.regular)
                                                        ],
                                                      )
                                            ...
                                            () => Column(
                                              ...
                                              children: [
                                                ...
                                                if (controller.bookingModel.value.holdCharges != null && controller.bookingModel.value.holdCharges != "0.0")
                                                  PriceRowView(
                                                    price: Constant.amountToShow(amount: controller.bookingModel.value.holdCharges.toString()),
                                                    title: "HoldCharge".tr,
                                                    priceColor: themeChange.isDarkTheme() ? AppThemData.greyShade25 : AppThemData.greyShade950,
                                                    titleColor: themeChange.isDarkTheme() ? AppThemData.greyShade25 : AppThemData.greyShade950,
                                                ...
                                                if (controller.bookingModel.value.nightCharge != null && controller.bookingModel.value.nightCharge != "0.0")
                                                  PriceRowView(
                                                    price: Constant.amountToShow(amount: controller.bookingModel.value.nightCharge.toString()),
                                                    title: "NightCharge".tr,
                                                    priceColor: themeChange.isDarkTheme() ? AppThemData.greyShade25 : AppThemData.greyShade950,
                                                    titleColor: themeChange.isDarkTheme() ? AppThemData.greyShade25 : AppThemData.greyShade950,
                                                  ).paddingOnly(bottom: 16),
                                                PriceRowView(
