...
import 'package:admin/app/modules/cab_detail/views/widget/pick_drop_point_view.dart';
                                        ...
                                        children: [
                                          ...
                                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                            ...
                                            Row(children: [
                                              ...
                                              GestureDetector(
                                                  onTap: () => Get.back(),
                                                  child: TextCustom(title: 'Intercity History'.tr, fontSize: 14, fontFamily: AppThemeData.medium, color: AppThemData.greyShade500)),
                                              const TextCustom(title: ' / ', fontSize: 14, fontFamily: AppThemeData.medium, color: AppThemData.greyShade500),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  children: [
                                                    TextCustom(
                                                        title: "Order ID # ${controller.interCityModel.value.id!.substring(0, 8)}", fontSize: 18, fontFamily: AppThemeData.bold),
                                                    spaceH(height: 2),
                                                    TextCustom(
                                                        title:
                                                ...
                                                spaceH(),
                                                Container(
                                                  child: Constant.bookingStatusText(context, controller.interCityModel.value.bookingStatus.toString()),
                                                ),
                                                spaceH(height: 40),
                                                Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  ...
                                                  children: [
                                                    ...
                                                    rowDataWidget(name: "Persons", value: controller.interCityModel.value.persons.toString(), themeChange: themeChange),
                                                  ],
                                                ),
                                                spaceH(height: 24),
                                                if (controller.driverModel.value.id != null)
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      spaceH(height: 16),
                                                      rowDataWidget(name: "ID", value: "# ${controller.driverModel.value.id.toString().substring(0, 6)}", themeChange: themeChange),
                                                ...
                                                Row(
                                                  children: [
                                                    (controller.interCityModel.value.paymentType == controller.paymentModel.value.cash!.name)
                                                        ? SvgPicture.asset("assets/icons/ic_cash.svg")
                                                        : (controller.interCityModel.value.paymentType == controller.paymentModel.value.wallet!.name)
                                                            ? SvgPicture.asset(
                                                                "assets/icons/ic_wallet.svg",
                                                                height: 24,
                                                                color: themeChange.isDarkTheme() ? AppThemData.lightGrey08 : AppThemData.black08,
                                                              )
                                                            : (controller.interCityModel.value.paymentType == controller.paymentModel.value.razorpay!.name)
                                                                ? Image.asset("assets/image/ig_razorpay.png", height: 24, width: 24)
                                                                : (controller.interCityModel.value.paymentType == controller.paymentModel.value.paypal!.name)
                                                                    ? Image.asset("assets/image/ig_paypal.png", height: 24, width: 24)
                                                                    : (controller.interCityModel.value.paymentType == controller.paymentModel.value.strip!.name)
                                                                        ? Image.asset("assets/image/ig_stripe.png", height: 24, width: 24)
                                                                        : (controller.interCityModel.value.paymentType == controller.paymentModel.value.payStack!.name)
                                                                            ? Image.asset("assets/image/ig_paystack.png", height: 24, width: 24)
                                                                            : (controller.interCityModel.value.paymentType == controller.paymentModel.value.mercadoPago!.name)
                                                                                ? Image.asset("assets/image/ig_marcadopago.png", height: 24, width: 24)
                                                                                : (controller.interCityModel.value.paymentType == controller.paymentModel.value.payFast!.name)
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(children: [
                                                      ...
                                                      Expanded(
                                                          child: rowDataWidget(
                                                              name: "Time", value: controller.interCityModel.value.rideStartTime.toString(), themeChange: themeChange)),
                                                    ]),
                                                    Row(children: [
                                                      SvgPicture.asset(
                                                      ...
                                                      SizedBox(
                                                        ...
                                                        child: CachedNetworkImage(
                                                            imageUrl: controller.interCityModel.value.vehicleType == null
                                                                ...
                                                                : controller.interCityModel.value.vehicleType!.image.toString(),
                                                            fit: BoxFit.cover,
                                                      ...
                                                      Expanded(
                                                          child: TextCustom(
                                                              title: (controller.interCityModel.value.vehicleType == null
                                                                  ? ""
                                                                  : controller.interCityModel.value.vehicleType!.title.toString()),
                                                              fontSize: 16,
                                                              fontFamily: AppThemeData.medium)),
                                                      Row(
                                                        children: [
                                                          ...
                                                          TextCustom(
                                                              title: (controller.interCityModel.value.vehicleType == null
                                                                  ? ""
                                                                  : controller.interCityModel.value.vehicleType!.persons.toString()),
                                                              fontSize: 16,
                                                              fontFamily: AppThemeData.regular)
                                                        ],
                                                      )
                                                ...
                                                PickDropPointView(
                                                  ...
                                                  stopAddress: controller.interCityModel.value.stops!.map((e) => e.address!).toList(),
                                                ),
                                              ],
                                            ),
                                          ),
                                        ...
                                        Container(
                                          ...
                                          child: Obx(
                                            () => Column(
                                              ...
                                              children: [
                                                PriceRowView(
                                                  price: Constant.amountShow(amount: controller.interCityModel.value.subTotal.toString()),
                                                  title: "Amount".tr,
                                                ...
                                                if (controller.interCityModel.value.holdCharges != null && controller.interCityModel.value.holdCharges != "0.0")
                                                  PriceRowView(
                                                    price: Constant.amountToShow(amount: controller.interCityModel.value.holdCharges.toString()),
                                                    title: "Hold Charges".tr,
                                                    priceColor: themeChange.isDarkTheme() ? AppThemData.greyShade25 : AppThemData.greyShade950,
                                                    titleColor: themeChange.isDarkTheme() ? AppThemData.greyShade25 : AppThemData.greyShade950,
                                                        ...
                                                        PriceRowView(
                                                            price: Constant.amountToShow(
                                                                amount: Constant.calculateTax(
                                                                        amount: Constant.intercityAmountBeforeTax(controller.interCityModel.value).toString(), taxModel: taxModel)
                                                                    .toString()),
                                                            title:
                                                ...
                                                PriceRowView(
                                                  price: Constant.amountShow(amount: Constant.calculateInterCityFinalAmount(controller.interCityModel.value).toString()),
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                          ...
                                                          SizedBox(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                spaceH(height: 16),
                                                                rowDataWidget(name: "ID", value: "# ${controller.driverModel.value.id!.substring(0, 6)}", themeChange: themeChange),
                                                                rowDataWidget(name: "Name", value: controller.driverModel.value.fullName.toString(), themeChange: themeChange),
                                                                rowDataWidget(
                                                                    name: "Phone No.",
                                                                    value: Constant.maskMobileNumber(
                                                    ...
                                                    TextCustom(title: "Address Details".tr, fontSize: 16, fontFamily: AppThemeData.bold),
                                                    spaceH(height: 20),
                                                    PickDropPointView(
                                                      pickUpAddress: controller.interCityModel.value.pickUpLocationAddress ?? '',
                                                      dropAddress: controller.interCityModel.value.dropLocationAddress ?? '',
                                                        ...
                                                        return Column(
                                                          children: [
                                                            PriceRowView(
                                                                price: Constant.amountToShow(
                                                                    amount: Constant.calculateTax(
                                                                            amount: Constant.intercityAmountBeforeTax(controller.interCityModel.value).toString(),
                                                                            taxModel: taxModel)
                                                                        .toString()),
                                                                title:
                                                                    "${taxModel.name!} (${taxModel.isFix == true ? Constant.amountToShow(amount: taxModel.value) : "${taxModel.value}%"})",
                                                    ...
                                                    Visibility(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          const TextCustom(title: "Ride Sharing", fontSize: 16, fontFamily: AppThemeData.bold),
                                                          const SizedBox(height: 8),
                                                          Container(
                                                            width: 400,
                                                            padding: const EdgeInsets.all(16),
                                                            ...
                                                            child: ListView.builder(
                                                                ...
                                                                itemBuilder: (context, index) {
                                                                  ...
                                                                  return Column(
                                                                    ...
                                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                                    children: [
                                                                      TextCustom(title: personModel.name.toString(), fontSize: 16, fontFamily: AppThemeData.medium),
                                                                      const SizedBox(
                                                                        height: 2,
                                                                      ),
                                                                      TextCustom(title: personModel.mobileNumber.toString(), fontSize: 16, fontFamily: AppThemeData.medium),
                                                  ...
                                                  children: [
                                                    ...
                                                    PriceRowView(
                                                      price: Constant.amountShow(
                                                        amount: controller.interCityModel.value.subTotal.toString(),
                                                      ),
                                                      title: "Amount".tr,
                                                      priceColor: themeChange.isDarkTheme() ? AppThemData.greyShade25 : AppThemData.greyShade950,
                                                      titleColor: themeChange.isDarkTheme() ? AppThemData.greyShade25 : AppThemData.greyShade950,
