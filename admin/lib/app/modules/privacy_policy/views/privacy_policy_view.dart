                              ...
                              CustomButtonWidget(
                                ...
                                onPress: () async {
                                  if (Constant.isDemo) {
                                    ...
                                    controller.privacyPolicy.value = txt;
                                    Constant.waitingLoader();
                                    String selectedType = controller.selectedUserType.value.toLowerCase();
                                    await FireStoreUtils.setPrivacyPolicy(selectedType, controller.privacyPolicy.value);
                                    ShowToastDialog.successToast("Privacy policy updated");
                                    Get.back();
                                  }
                                },
                              ),
                          ...
                          child: Obx(
                            () => HtmlEditor(
                              ...
                              htmlEditorOptions: HtmlEditorOptions(
                                ...
                                initialText: controller.privacyPolicy.value,
