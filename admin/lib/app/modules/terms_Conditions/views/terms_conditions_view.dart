...
class TermsConditionsView extends GetView<TermsConditionsController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<TermsConditionsController>(
                                ...
                                () => SizedBox(
                                  ...
                                  child: DropdownButtonFormField(
                                    ...
                                    onChanged: (String? type) async {
                                      controller.selectedUserType.value = type ?? "Driver";
                                      controller.getSettingData();
                                    },
                                    value: controller.selectedUserType.value,
                                    icon: const Icon(Icons.keyboard_arrow_down_outlined),
                                    items: controller.userTypeList.map<DropdownMenuItem<String>>((String value) {
                              ...
                              CustomButtonWidget(
                                ...
                                onPress: () async {
                                  if (Constant.isDemo) {
                                    ...
                                    controller.termsConditionText.value = txt;
                                    Constant.waitingLoader();
                                    String selectedType = controller.selectedUserType.value.toLowerCase();
                                    await FireStoreUtils.setTermsAndCondition(selectedType, controller.termsConditionText.value);
                                    ShowToastDialog.successToast("Terms & Conditions Updated");
                                    Get.back();
                                  }
                                },
                              ),
                          ...
                          child: Obx(
                            () => HtmlEditor(
                              ...
                              htmlEditorOptions: HtmlEditorOptions(
                                ...
                                initialText: controller.termsConditionText.value,
