                      ...
                      children: <Widget>[
                        Container(
                          ...
                          padding: EdgeInsets.only(top: MediaQuery
                              .of(context)
                              .padding
                              .top, bottom: 30, left: 16, right: 24),
                          child: Obx(
                                () =>
                                InkWell(
                                  onTap: () async {
                        ...
                        if (Constant.isSubscriptionEnable == true)
                          Padding(
                            ...
                            child: GestureDetector(
                                onTap: () {
                                  Get.back();
                                  Get.to(() => SubscriptionPlanView(isFromProfile: true));
                                },
                                child: Container(
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(16), image: DecorationImage(image: AssetImage("assets/images/subscription_card.png"), fit: BoxFit.cover)),
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Get the our exclusive subscription plans. Enjoy more features, better rides.".tr,
                                ...
                                Switch(
                                  ...
                                  onChanged: (value) async {
                                    ...
                                    if (isUpdated) {
                                      ...
                                      ShowToastDialog.showToast("Failed to update status please try again".tr);
                                    }
                                  },
                                ),
                          ),
                        ...
                        ExpansionTileItem(
                          ...
                          (controller.drawerIndex.value == 1 || controller.drawerIndex.value == 2 || controller.drawerIndex.value == 3 || controller.drawerIndex.value == 13)
                              ...
                              : AppThemData.black,
                          children: [
                            if (Constant.isCabAvailable == true)
                              ListTile(
                                title: Text(
                                  "Cab Rides".tr,
                                  style: GoogleFonts.inter(
                            ...
                            if (Constant.intercitySharingDocuments.first.isAvailable || Constant.intercityPersonalDocuments.first.isAvailable)
                              ListTile(
                                title: Text(
                                  "Intercity Rides".tr,
                                  style: GoogleFonts.inter(
                            ...
                            if (Constant.parcelDocuments.isNotEmpty && Constant.parcelDocuments.first.isAvailable)
                              ListTile(
                                title: Text(
                                  "Parcel Rides".tr,
                                  style: GoogleFonts.inter(
                            ...
                            if (Constant.isRentalAvailable == true)
                              ListTile(
                                title: Text(
                                  ...
                                  style: GoogleFonts.inter(
                                      fontSize: 16,
                                      color: controller.drawerIndex.value == 13
                                          ? AppThemData.warning06
                                          : themeChange.isDarkTheme()
                                          ? AppThemData.white
                                          : themeChange.isDarkTheme()
                        ...
                        ListTile(
                          leading: SvgPicture.asset(
                            ...
                            colorFilter: ColorFilter.mode(
                              controller.drawerIndex.value == 17 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                              BlendMode.srcIn,
                            ),
                          ),
                          trailing: Icon(
                            Icons.keyboard_arrow_right_rounded,
                            size: 30,
                            color: controller.drawerIndex.value == 17 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                          ),
                          title: Text(
                        ...
                        ListTile(
                          leading: SvgPicture.asset(
                            "assets/icon/ic_emergency.svg",
                            colorFilter: ColorFilter.mode(
                              controller.drawerIndex.value == 18 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                              BlendMode.srcIn,
                            ),
                          ),
                          trailing: Icon(
                            Icons.keyboard_arrow_right_rounded,
                            size: 30,
                            color: controller.drawerIndex.value == 18 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                          ),
                          title: Text(
                            "SOS Request".tr,
                            style: GoogleFonts.inter(
                        ...
                        ListTile(
                          leading: SvgPicture.asset(
                            ...
                            colorFilter: ColorFilter.mode(
                              controller.drawerIndex.value == 4 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                              BlendMode.srcIn,
                            ),
                          ),
                          trailing: Icon(
                        ...
                        ListTile(
                          leading: Icon(
                            ...
                            size: 20,
                            color: controller.drawerIndex.value == 16 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                          ),
                          trailing: Icon(
                            Icons.keyboard_arrow_right_rounded,
                            size: 30,
                        ...
                        ListTile(
                          leading: SvgPicture.asset(
                            ...
                            height: 20,
                            colorFilter: ColorFilter.mode(
                              controller.drawerIndex.value == 5 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                              BlendMode.srcIn,
                            ),
                          ),
                          trailing: Icon(
                        ...
                        Constant.isDocumentVerificationEnable == false
                            ? SizedBox()
                            : Column(
                          children: [
                            ListTile(
                              leading: SvgPicture.asset(
                                "assets/icon/ic_document_drawer.svg",
                                colorFilter: ColorFilter.mode(
                                  controller.drawerIndex.value == 7 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                                  BlendMode.srcIn,
                                ),
                              ),
                              trailing: Icon(
                                Icons.keyboard_arrow_right_rounded,
                                size: 30,
                                color: controller.drawerIndex.value == 7 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                              ),
                              title: Text(
                                "Document".tr,
                                style: GoogleFonts.inter(
                        ...
                        ListTile(
                          leading: SvgPicture.asset(
                            ...
                            height: 22,
                            colorFilter: ColorFilter.mode(
                              controller.drawerIndex.value == 8 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                              BlendMode.srcIn,
                            ),
                          ),
                          trailing: Icon(
                            Icons.keyboard_arrow_right_rounded,
                            size: 30,
                            color: controller.drawerIndex.value == 8 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                          ),
                          title: Text(
                            "Support".tr,
                            style: GoogleFonts.inter(
                        ...
                        ListTile(
                          ...
                          leading: Icon(
                            ...
                            color: controller.drawerIndex.value == 10 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                          ),
                          trailing: Icon(
                            Icons.keyboard_arrow_right_rounded,
                            size: 30,
                        ...
                        ListTile(
                          leading: SvgPicture.asset(
                            ...
                            colorFilter: ColorFilter.mode(
                              controller.drawerIndex.value == 12 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                              BlendMode.srcIn,
                            ),
                          ),
                          trailing: const Icon(Icons.keyboard_arrow_right_rounded, size: 30),
                          title: Text(
                            ...
                            style: GoogleFonts.inter(
                                fontSize: 16,
                                color: controller.drawerIndex.value == 12 ? AppThemData.primary500 : (themeChange.isDarkTheme() ? AppThemData.white : AppThemData.black),
                                fontWeight: FontWeight.w400),
                          ),
                          onTap: () {
                            Get.back();
