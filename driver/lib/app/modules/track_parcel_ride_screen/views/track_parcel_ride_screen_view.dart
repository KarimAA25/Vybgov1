                    ...
                    children: [
                        ...
                        child: Constant.selectedMap == "Google Map"
                            ? GoogleMap(
                                initialCameraPosition: CameraPosition(
                                  target: LatLng(
                                    controller.parcelModel.value.pickUpLocation!.latitude ?? 0.0,
                                    controller.parcelModel.value.pickUpLocation!.longitude ?? 0.0,
                                  ),
                                  zoom: 14,
                                ),
                      ...
                      Positioned(
                        ...
                        child: Obx(() {
                          ...
                          if (controller.parcelModel.value.bookingStatus == BookingStatus.bookingAccepted) {
                            nextStop = "Driver is on the way to pick up your parcel";
                          } else if (controller.parcelModel.value.bookingStatus == BookingStatus.bookingOngoing ||
                              controller.parcelModel.value.bookingStatus == BookingStatus.bookingOnHold) {
                            nextStop = "Heading to delivery location";
                          } else if (controller.parcelModel.value.bookingStatus == BookingStatus.bookingCompleted) {
