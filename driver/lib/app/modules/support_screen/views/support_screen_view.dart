import 'package:driver/app/modules/support_screen/controllers/support_screen_controller.dart';
                  ...
                  : (controller.supportTicketList.isEmpty)
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              onTap: () {
                                Get.toNamed(Routes.SUPPORT_TICKET_DETAILS, arguments: {"supportTicket": controller.supportTicketList[index]});
                              },
                              child: Container(
                                        ...
                                        Text(
                                          ...
                                          style: GoogleFonts.inter(
                                            ...
                                            color: (controller.supportTicketList[index].status.toString() == "pending"
                                                ...
                                                : (controller.supportTicketList[index].status.toString() == "accepted" ? AppThemData.success500 : AppThemData.error08)),
                                          ),
                                        )
                                      ],
                                    ),
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          ...
                                          style: GoogleFonts.inter(
                                              fontSize: 12, fontWeight: FontWeight.w400, color: themeChange.isDarkTheme() ? AppThemData.grey300 : AppThemData.grey600),
                                        ),
                                        Text(
