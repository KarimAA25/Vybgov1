                  ...
                  child: Constant.selectedMap == "Google Map"
                      ? GoogleMap(
                          initialCameraPosition: CameraPosition(
                            target: LatLng(controller.parcelModel.value.pickUpLocation!.latitude ?? 0.0, controller.parcelModel.value.pickUpLocation!.longitude ?? 0.0),
                            zoom: 5,
                          ),
                      ...
                      : osm.FlutterMap(
                          ...
                          options: osm.MapOptions(
                            initialCenter:
                                latlang.LatLng(controller.parcelModel.value.pickUpLocation?.latitude ?? 0.0, controller.parcelModel.value.pickUpLocation?.longitude ?? 0.0),
                            initialZoom: 5,
                          ),
                          children: [
                            osm.TileLayer(
                                ...
                                RoundShapeButton(
                                  ...
                                  onTap: () {
                                    Get.to(OtpParcelScreenView(
                                      interCityBookingModel: controller.parcelModel.value,
                                    ));
                                  },
                                  size: Size(Responsive.width(43, context), 42),
                                )
