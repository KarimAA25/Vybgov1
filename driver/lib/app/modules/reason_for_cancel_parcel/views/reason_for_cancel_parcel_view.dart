...
class ReasonForCancelParcelView extends StatelessWidget {
  final ParcelModel bookingInterCityModel;

  const ReasonForCancelParcelView({super.key, required this.bookingInterCityModel});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetBuilder(
        init: ReasonForCancelParcelController(),
        builder: (controller) {
          return Scaffold(
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return CustomDialogBox(
                              title: "Your parcel is successfully cancelled.",
