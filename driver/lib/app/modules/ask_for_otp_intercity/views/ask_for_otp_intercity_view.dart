import 'package:driver/app/modules/otp_intercity_screen/views/otp_intercity_screen_view.dart';
...
class AskForOtpInterCityView extends StatelessWidget {
  const AskForOtpInterCityView({super.key});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetX(
        init: AskForOtpInterCityController(),
        builder: (controller) {
          return Scaffold(
                  ...
                  child: Constant.selectedMap == "Google Map"
                      ...
                      : osm.FlutterMap(
                          ...
                          options: osm.MapOptions(
                            initialCenter:
                                latlang.LatLng(controller.interCityModel.value.pickUpLocation?.latitude ?? 0.0, controller.interCityModel.value.pickUpLocation?.longitude ?? 0.0),
                            initialZoom: 5,
                          ),
                          children: [
                            osm.TileLayer(
                            ...
                            //     marker: const DefaultLocationMarker(child: Icon(Icons.location_pin, color: Colors.white, size: 20)),
