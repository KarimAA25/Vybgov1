import 'package:driver/app/modules/otp_rental_screen/views/otp_rental_screen_view.dart';
...
class AskForOtpRentalView extends StatelessWidget {
  const AskForOtpRentalView({super.key});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetX(
        init: AskForOtpRentalController(),
        builder: (controller) {
          return Scaffold(
                  ...
                  child: Constant.selectedMap == "Google Map"
                      ...
                      : osm.FlutterMap(
                          ...
                          options: osm.MapOptions(
                            initialCenter:
                                latlang.LatLng(controller.rentalModel.value.pickUpLocation?.latitude ?? 0.0, controller.rentalModel.value.pickUpLocation?.longitude ?? 0.0),
                            initialZoom: 5,
                          ),
                          children: [
                            osm.TileLayer(
