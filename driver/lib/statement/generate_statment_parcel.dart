...
Future<void> generateAndDownloadPdfParcel(List<ParcelModel> bookingList, DateTimeRange selectedRange) async {
  ...
  Sheet sheet = excel['Parcel_History'];
  excel.setDefaultSheet('Parcel_History');
  ...
  if (fileBytes != null) {
    ...
    debugPrint("❌ Failed to generate Excel file bytes.");
    ShowToastDialog.toast('Failed to generate Excel file');
  }
}
