...
import 'package:customer/app/modules/cab_ride_details/controllers/cab_ride_details_controller.dart';
...
class PaymentDialogView extends StatelessWidget {
  const PaymentDialogView({super.key});
                ...
                child: RoundShapeButton(
                  ...
                  onTap: () async {
                    if (controller.selectedPaymentMethod.value == Constant.paymentModel!.cash!.name) {
                      ...
                      controller.bookingModel.value.paymentType = controller.selectedPaymentMethod.value;
                      controller.bookingModel.value.paymentStatus = false;
                      await FireStoreUtils.setBooking(controller.bookingModel.value).then(
                        (value) async {
                          if (value == true) {
