...
class RentalReasonForCancelView extends StatelessWidget {
  const RentalReasonForCancelView({super.key});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetBuilder(
        init: RentalReasonForCancelController(),
        builder: (controller) {
          return Scaffold(
              ...
              child: Row(
                ...
                children: [
                  ...
                  RoundShapeButton(
                    ...
                    buttonTextColor: AppThemData.black,
                    onTap: () async {
                      bool isCancelled = await controller.cancelBooking(controller.rentalBookingModel.value);
                      if (isCancelled) {
                        showDialog(
                          context: context,
                          ...
                          builder: (context) {
                            return CustomDialogBox(
                              ...
                              positiveClick: () async {
                                if (controller.rentalBookingModel.value.driverId != null) {
