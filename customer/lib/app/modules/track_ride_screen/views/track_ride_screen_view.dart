              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Obx(() {
                      String nextStop = "";
                      // If driver is assigned but hasn't started moving → heading to pickup
                      if (controller.bookingModel.value.bookingStatus == BookingStatus.bookingAccepted) {
                        nextStop = "Driver is on the way to pick you up";
                      }
                      // If there are stops en route
                      else if (controller.bookingModel.value.stops != null && controller.bookingModel.value.stops!.isNotEmpty) {
                        nextStop = "Next Stop: ${controller.bookingModel.value.stops!.first.address ?? "Stop"}";
                      }
                      // Ride is ongoing, heading to drop-off
                        ...
                        nextStop = "Heading to your destination";
                      }
                      // Ride completed or unknown status
                      else {
