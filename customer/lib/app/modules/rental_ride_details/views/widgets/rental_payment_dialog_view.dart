...
class RentalPaymentDialogView extends StatelessWidget {
  const RentalPaymentDialogView({super.key});
                ...
                child: RoundShapeButton(
                  ...
                  onTap: () async {
                    if (controller.selectedPaymentMethod.value == Constant.paymentModel!.cash!.name) {
                      ...
                      controller.rentalModel.value.paymentStatus = false;
                      controller.rentalModel.value.paymentType = controller.selectedPaymentMethod.value;
                      await FireStoreUtils.setRentalRide(controller.rentalModel.value);
                      DriverUserModel? receiverUserModel = await FireStoreUtils.getDriverUserProfile(controller.rentalModel.value.driverId.toString());
                      ...
                      await SendNotification.sendOneNotification(
                          ...
                          bookingId: controller.rentalModel.value.id,
                          driverId: controller.rentalModel.value.driverId.toString(),
