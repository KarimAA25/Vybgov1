...
import 'package:customer/payments/midtrans/midtrans_payment_screen.dart';
...
class MyWalletController extends GetxController {
  ...
  Future<Null> flutterWaveInitiatePayment({required BuildContext context, required String amount}) async {
    ...
    if (response.statusCode == 200) {
      ...
      await Get.to(FlutterWaveScreen(
        ...
        callBackUrl: "${paymentModel.value.flutterWave!.callBackUrl}",
      ))!
          .then((value) {
  ...
  Future<void> payStackPayment(String totalAmount) async {
    await PayStackURLGen.payStackURLGen(
        ...
        .then((value1) async {
      if (value1 != null) {
        PayStackUrlModel payStackModel = value1;
        ShowToastDialog.closeLoader();
...
// :::::::::::::::::::::::::::::::::::::::::::: MidTrans ::::::::::::::::::::::::::::::::::::::::::::::::::::
  ...
  Future<String?> createMidtransPaymentLink(
      {required String orderId, required double amount, required String customerEmail}) async {
