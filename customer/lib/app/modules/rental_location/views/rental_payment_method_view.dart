...
class RentalPaymentMethodView extends StatelessWidget {
  const RentalPaymentMethodView({super.key});
          ...
          return Scaffold(
            ...
            bottomNavigationBar: Padding(
              padding: EdgeInsets.only(
                  bottom: MediaQuery.of(context).padding.bottom + 14, left: ((Responsive.width(100, context) - 208) / 2), right: ((Responsive.width(100, context) - 208) / 2)),
            ...
            body: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    // RentalCategoryView(vehicleType: controller.vehicleTypeList[controller.selectVehicleTypeIndex.value], index: index, isForPayment: true),
                    Container(
                      ...
                      child: Obx(
                        () => Column(
                          ...
                          children: [
                            PriceRowView(
                              price: Constant.amountToShow(amount: controller.subTotal.toString()),
                              title: "Sub Total".tr,
                            ...
                            PriceRowView(
                                ...
                                title: controller.selectedCouponModel.value.id == null ? "Discount" : "Discount (${controller.selectedCouponModel.value.code})".tr,
                                        ...
                                        price: Constant.amountToShow(
                                            amount: Constant.calculateTax(
                                                    amount: (((double.parse(controller.subTotal.value.toString())) +
                                                                double.parse(controller.extraHourCharge.value.toString()) +
                                                                double.parse(controller.extraKmCharge.value.toString())) -
                                                            (double.parse(controller.discountAmount.value.toString())))
                                                        .toString(),
                                                    taxModel: taxModel)
                                                .toString()),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              await Get.to(const CouponScreenView())!.then(
                                (value) {
                                  if (value != null) {
